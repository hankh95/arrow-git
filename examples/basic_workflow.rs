...
fn main() {
    ...
    let c1 = create_commit(&obj, &mut commits, "Initial", None, "agent").unwrap();
    ...
    .unwrap();
    let d = diff(&obj, &commits, &c1.commit_id, &c2.commit_id).unwrap();
    println!("Diff: +{} -{}", d.additions, d.deletions);
